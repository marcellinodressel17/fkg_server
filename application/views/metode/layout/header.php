...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/css/metode/style.css">
    <!-- Boxiocns CDN Link -->
...
<body>
    <div class="sidebar close">
        <div class="logo-details">
            ...
            <span class="logo_name">Eresta Kmeans</span>
        </div>
        <ul class="nav-links">
            <li>
                <div class="iocn-link">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="<?= base_url("metode/kmeans//index"); ?>">Kmeans</a></li>
                    <li><a href="<?= base_url("metode/kmeans/iterasi_hasil"); ?>">DBI</a></li>
                    <li><a href="<?= base_url("metode/kmeans/index"); ?>">Pengelompokan</a></li>
                </ul>
            </li>
            <li>
