<div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="<?= base_url('/assets/logo/eresta_dev.png') ?>" width="180px" alt="" /></a>
                <strong><img src="<?= base_url('/assets/school/img/logo/logosn.png') ?>" alt="" /></strong>
            </div>
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="#"><img src="<?= base_url('/assets/school/img/notification/4.jpg') ?>" alt="" /></a>
