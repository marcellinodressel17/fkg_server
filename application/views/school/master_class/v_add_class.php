<section class="home-section">
    ...
    <main>
        <div class="container-fluid">
            ...
            <form action=<?= base_url('/project/school/administrator/master_class/proccess_add_class') ?> method="post">
                <div class="form_group">
                    <label>Nama Kelas : </label>
                    <input type="text" class="form-control selectric" name="name_class" required>
