<section class="home-section">
    ...
    <div class="home-content">
        ...
        <span class="text"><i class='bx bxs-school'></i> Tambah Master Shift</span>
    </div>
    ...
    <main>
        <div class="container-fluid">
            ...
            <form action=<?= base_url('/project/school/administrator/master_shift/proccess_add_shift') ?> method="post">
                <div class="form_group">
                    <label>Nama Shift : </label>
                    <input type="text" class="form-control selectric" name="name_shift" required>
                ...
                <div class="form_group">
                    <label>Mulai : </label>
                    <input type="time" class="form-control selectric" name="start_shift" required>
                    <?= form_error('start_shift', '<small class="text-danger">', '</small>'); ?>
                </div>
                <div class="form_group">
                    <label>Selesai : </label>
                    <input type="time" class="form-control selectric" name="end_shift" required>
